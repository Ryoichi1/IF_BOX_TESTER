...
namespace IfBoxTester
{
    public class ViewModelTestStatus : BindableBase
    {
        ...
        private Visibility _VisTestSettingInfo = Visibility.Visible;
        public Visibility VisTestSettingInfo
        {
            get { return _VisTestSettingInfo; }

            set
            {
                SetProperty(ref _VisTestSettingInfo, value);
            }
        }


        //エラー詳細表示ボタンの可視切り替え
        private Visibility _VisMessSub = Visibility.Hidden;
        public Visibility VisMessSub
        {
            get { return _VisMessSub; }

            set
            {
                SetProperty(ref _VisMessSub, value);
            }
        }
        ...
        //ボリューム調整時の回転矢印（左側)の可視切り替え
        private Visibility _VisAllowLeft = Visibility.Hidden;
        public Visibility VisAllowLeft
        {
            get { return _VisAllowLeft; }

            set
            {
                SetProperty(ref _VisAllowLeft, value);
            }
        }

        //ボリューム調整時の回転矢印（右側)の可視切り替え
        private Visibility _VisAllowRight = Visibility.Hidden;
        public Visibility VisAllowRight
        {
            get { return _VisAllowRight; }

            set
            {
                SetProperty(ref _VisAllowRight, value);
            }
        }
